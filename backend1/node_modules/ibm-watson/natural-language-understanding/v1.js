...
var NaturalLanguageUnderstandingV1 = /** @class */ (function (_super) {
    ...
    NaturalLanguageUnderstandingV1.prototype.analyze = function (params) {
        ...
        var _validParams = ['features', 'text', 'html', 'url', 'clean', 'xpath', 'fallbackToRaw', 'returnAnalyzedText', 'language', 'limitTextCharacters', 'signal', 'headers'];
    ...
    NaturalLanguageUnderstandingV1.prototype.createCategoriesModel = function (params) {
        ...
        var _validParams = ['language', 'trainingData', 'trainingDataContentType', 'name', 'userMetadata', 'description', 'modelVersion', 'workspaceId', 'versionDescription', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    NaturalLanguageUnderstandingV1.prototype.updateCategoriesModel = function (params) {
        ...
        var _validParams = ['modelId', 'language', 'trainingData', 'trainingDataContentType', 'name', 'userMetadata', 'description', 'modelVersion', 'workspaceId', 'versionDescription', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    NaturalLanguageUnderstandingV1.prototype.createClassificationsModel = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['language', 'trainingData'];
        var _validParams = ['language', 'trainingData', 'trainingDataContentType', 'name', 'userMetadata', 'description', 'modelVersion', 'workspaceId', 'versionDescription', 'trainingParameters', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    NaturalLanguageUnderstandingV1.prototype.updateClassificationsModel = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['modelId', 'language', 'trainingData'];
        var _validParams = ['modelId', 'language', 'trainingData', 'trainingDataContentType', 'name', 'userMetadata', 'description', 'modelVersion', 'workspaceId', 'versionDescription', 'trainingParameters', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
