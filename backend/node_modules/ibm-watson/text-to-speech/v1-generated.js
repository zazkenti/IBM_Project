...
var TextToSpeechV1 = /** @class */ (function (_super) {
    ...
    TextToSpeechV1.prototype.getVoice = function (params) {
        ...
        var _validParams = ['voice', 'customizationId', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.synthesize = function (params) {
        ...
        var _validParams = ['text', 'accept', 'voice', 'customizationId', 'spellOutMode', 'ratePercentage', 'pitchPercentage', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.getPronunciation = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['text'];
        var _validParams = ['text', 'voice', 'format', 'customizationId', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.createCustomModel = function (params) {
        ...
        var _validParams = ['name', 'language', 'description', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.updateCustomModel = function (params) {
        ...
        var _validParams = ['customizationId', 'name', 'description', 'words', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.addWord = function (params) {
        ...
        var _validParams = ['customizationId', 'word', 'translation', 'partOfSpeech', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.getWord = function (params) {
        ...
        var _validParams = ['customizationId', 'word', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.addCustomPrompt = function (params) {
        ...
        var _validParams = ['customizationId', 'promptId', 'metadata', 'file', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.getCustomPrompt = function (params) {
        ...
        var _validParams = ['customizationId', 'promptId', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.createSpeakerModel = function (params) {
        ...
        var _validParams = ['speakerName', 'audio', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    TextToSpeechV1.prototype.getSpeakerModel = function (params) {
        ...
        var _validParams = ['speakerId', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
...
(function (TextToSpeechV1) {
    ...
    (function (GetVoiceConstants) {
        ...
        (function (Voice) {
            ...
            Voice["EN_GB_GEORGEEXPRESSIVE"] = "en-GB_GeorgeExpressive";
            ...
            Voice["EN_US_ELLIENATURAL"] = "en-US_EllieNatural";
            ...
            Voice["ES_LA_DANIELAEXPRESSIVE"] = "es-LA_DanielaExpressive";
            ...
            Voice["PT_BR_LUCASEXPRESSIVE"] = "pt-BR_LucasExpressive";
